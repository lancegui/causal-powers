...
| **Exploratory trends pass** | The "what's going on in this data" first look — not yet paper-bound | Lighter gate, but the composition check still fires the moment a number *surprises* you, because that's exactly when an artifact is masquerading as a finding. |
