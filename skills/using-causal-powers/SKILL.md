...
| **`analysis-state-management`** | Creating, updating, resuming, or compacting durable analysis state — `docs/analysis/index.yaml`, current phase, decisions, artifacts, runs, and subagent handoffs. The replacement for one growing `analysis-plan.md`. |
